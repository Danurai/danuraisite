...
(def careers [
  {
    ...
    :spex [
      {:name "Assassin" :skills ["Melee" "Ranged - Heavy" "Skullduggery" "Stealth"]}
      {:name "Gadgeteer" :skills ["Coercion" "Mechanics" "Brawl" "Ranged - Light"]}
      {:name "Survivalist" :skills ["Xenology" "Perception" "Resilience" "Survival"]}]
  }
  {
    :name "Explorer" 
    :skills ["Astrogation" "Cool" "Lore" "Outer Rim" "Xenology" "Perception" "Piloting - Space" "Survival"]
    :spex [
      {:name "Fringer" :skills ["Astrogation" "Coordination" "Negotiation" "Streetwise"]}
      {:name "Scout" :skills ["Athletics" "Medicine" "Piloting - Planetary" "Survival"]}
      {:name "Trader" :skills ["Deception" "Core Worlds" "Underworld" "Negotiation"]}]
  }])
